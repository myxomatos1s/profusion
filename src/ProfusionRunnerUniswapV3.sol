...
import './ProfusionRunnerWithCallback.sol';
import './libraries/Path.sol';
import './libraries/SafeCast.sol';
import './interfaces/IUniswapV3Pool.sol';
import './interfaces/IUniswapV3SwapCallback.sol';

contract ProfusionRunnerUniswapV3 is ProfusionRunnerBase, ProfusionRunnerWithCallback, IUniswapV3SwapCallback {
  ...
  constructor(
    address _profusionBank,
    address _weth,
    address _factory,
    bytes32 _codeHash
  ) ProfusionRunnerBase(_profusionBank, _weth) {
    factory = _factory;
    codeHash = _codeHash;
  }
